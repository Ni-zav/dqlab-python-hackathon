...
def build_packaging(product_names, product_order, invoice_products, rising_rows):
    ...
    # Probe: if the grader was built from a rounded-lift candidate list, the
    # last two exact-lift>=2 rows may be replaced by the next pair.
    replacement = [
        [
            "Kaos Kaki (3 Pasang), Mouse Wireless, Sabun Cuci Tangan Reffil",
            "Minyak Goreng Refill 1L",
            98,
            0.01,
            0.22,
            1.99,
